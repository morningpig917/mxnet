...
#ifndef MXNET_OPERATOR_IFFT_INL_H
#define MXNET_OPERATOR_IFFT_INL_H
...
public:
  ...
  virtual void Backward(const OpContext &ctx,
    ...
    cufftPlanMany(&plan, 1, &dim_, nullptr, 0, 0, nullptr, 0, 0, CUFFT_C2C, param_.compute_size);
    for (size_t idx=0; idx<num_compute; ++idx) {
      complex_data = complex_pad_imag(grad.Slice(idx*param_.compute_size, idx*param_.compute_size+param_.compute_size));
